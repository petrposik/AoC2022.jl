...
@testset "AoC2022" begin
    ...
    #     @test AoC2021.closing_score("}}]])})]") == 288957
    #     @test AoC2021.day10("../data/test_input10.txt") == (26397, 288957)
    #     @test AoC2021.day10("../data/input10.txt") == (216297, 2165057169)
    # end

    # @testset "Day 11" begin
    #     state0 = AoC2021.parse_matrix(IOBuffer("11111\n19991\n19191\n19991\n11111"))
    #     state1 = AoC2021.parse_matrix(IOBuffer("34543\n40004\n50005\n40004\n34543"))
    #     AoC2021.step!(state0)
    #     @test state0 == state1
    #     @test AoC2021.day11("../data/test_input11.txt") == (1656, 195)
    #     @test AoC2021.day11("../data/input11.txt") == (1757, 422)
    # end
end
